# Alewife (*Alosa pseudoharengus*) {#alewife}

This chapter is dedicated to the habitat preferences and life cycle of alewives (*Alosa pseudoharengus*) for the United States. Alewives are widely distributed throughout the Northeastern United States, thriving in freshwater rivers and estuaries along the Atlantic coast (ASMFC 1985). While historically known for extensive migrations to spawn in freshwater tidal systems, limited information is available about estuary movements for alewives. 

Despite their historical significance, alewife populations have encountered significant declines. Various factors contribute to this decline, including deteriorating water quality, habitat loss, offshore bycatch/overfishing, increased predation, and dam construction [@kocovsky_linking_2008; @nmfs_national_marine_fisheries_service_species_2009; @bethoney_environmental_2014; @waldman_north_2022]. Recent stock assessments reveal diverse trends in documented alewife runs over the last ten years, with some populations showing signs of stabilization or even growth [@asmfc_river_2017]. The consideration for inclusion in the U.S. Endangered Species List has also been raised, as indicated in reports by the National Marine Fisheries Service in 2013 [@nmfs_national_marine_fisheries_service_endangered_2013]. In 2019, the National Marine Fisheries Service concluded that listing the alewife as threatened or endangered under the Endangered Species Act (ESA) was not warranted [@nmfs_national_marine_fisheries_service_not_2019].

This chapter aims to explore the favorable habitat conditions for spawning alewife adults, non-migratory juveniles, as well as eggs and larvae, considering factors such as temperature, depth, salinity, flow velocity, and substrate.

## Life Cycle Overview

Alewives have a diadrmous life cycle with distinct stages and behaviors. Adult alewives are primarily a marine occupant with a largely unknown marine territory and travel inland yearly to spawn. Spawning occurs in waves during spring, triggered by rising water temperatures and increasing day length [@asmfc_amendment_2009; @mccartin_new_2019; @able_alewife_2020]. Adult alewives migrate upstream from marine environments to suitable brackish or freshwater spawning habitats [@pardue_habitat_1983; @collette_fishes_2002; @greene_atlantic_2009]. Recent observations also suggest a correlation between alewife migration and the lunar phase [@legett_daily_2021].

Alewives exhibit a seasonal migration pattern from south to north, typically occurring from March in southern regions to May in northern areas. During this migration, adult alewives may detour into estuaries, where they find suitable conditions for rest before continuing their journey upstream [@greene_atlantic_2009]. Upon arrival at the spawning grounds, adults engage in immense spawning runs, where alewives deposit their adhesive eggs over a variety of substrates [@oconnell_spawning_1997; @able_alewife_2020]. After spawning, both males and females return to the marine environment.
...
After this stage, larvae remain in freshwater to grow and migrate downstream towards more brackish areas, maturing into juvenile fish [@pardue_habitat_1983]. These brackish areas serve as nurseries until the juvenile alewives migrate to the sea [@laney_relationship_1997; @kosa_processes_2001]. However, the survival rates for both larvae and migratory adults in the estuary are notably low, with only a small percentage of larvae successfully reaching the sea, potentially as low as 1%, and mortality rates for migratory adults during a spawning season can reach as high as 90% [@kissil_spawning_1974; @brady_part_2005].

## Spawning Adult Alewives

### Habitat Preferences

Spawning adult alewives exhibit specific habitat preferences and requirements. Their annual migration is energetically demanding, with notable variations in observed behavior of migrating fish. Some studies suggest fasting during the day and extensive feeding at night, while others report refraining from eating until their return downstream to productive tidal habitats [@janssen_feeding_1980; @collette_fishes_2002; @greene_atlantic_2009].

Preferred spawning habitats include lacustrine and fluvial environments rather than riverine ones [@reback_survey_2004; @frank_role_2011]. Alewives spawn and rear in upper river pools and ponds [@turner_juvenile_2016; @greene_atlantic_2009].

#### Temperature

Spawning adult alewives exhibit distinct temperature preferences crucial to their reproductive success and migration patterns. The spawning process commences at temperatures around 10.5 °C, with upstream migration initiating within the range of 5°C to 10°C [@cianci_larval_1969; @mullen_species_1986; @loesch_overview_1987; @munroe_overview_2000; @reback_survey_2004]. Notably, limited in-stream movement is observed below 8°C or over 18°C, emphasizing the species' preference for moderate temperature conditions [@durbin_effects_1979; @collette_fishes_2002]. Spawning ceases at temperatures exceeding 27°C, indicating an upper limit for optimal reproductive activity [@kissil_spawning_1974; @pardue_habitat_1983; @brown_habitat_2000; @reback_survey_2004]. The optimal temperature range for successful spawning is broadly identified as 10°C to 22°C, with consensus suggesting peak spawning occurring within the narrower range of 12 to 16 degrees Celsius [@tyus_movements_1974; @pardue_habitat_1983; @oconnell_spawning_1997; @collette_fishes_2002]. While deviations from the optimal temperature range can impact spawning success and migration timing.

#### Depth

Spawning adult alewives exhibit specific depth preferences during their reproductive activities. In tidally affected habitat, the preference of alewives for depths ranging from Mean Low Tide (MLT) to 10 meters indicates their affinity for shallow to moderately deep water  [@brown_habitat_2000]. Other studies report that alewives favor more shallow spawning habitats ranging from 0.15 to 3 meters [@pardue_habitat_1983; @greene_atlantic_2009], with significant spawning recorded around 0.5 meters [@kosa_processes_2001]. Additional field observations, reveal a significant proportion of alewives occupying habitats as shallow as 2 meters [@mather_assessing_2012], with the majority of spawning occurring at less than 1 m [@murdy_fishes_1997]. These observations in depth reflect the preference of spawning alewives to shallow conditions during their reproductive phase.

#### Salinity

The documented behavior of alewives challenges conventional beliefs about anadromous species exclusively relying on freshwater environments for spawning. Observations reveal that alewives engage in spawning activities in freshwater tidal habitats with minimal salinity concentrations, demonstrating adaptability to environments with salinity levels below 0.5 psu [@pardue_habitat_1983; @brown_habitat_2000]. This adaptability extends to tolerating higher salinity levels, with successful spawning observed in concentrations of 8 psu [@able_alewife_2020]. Other research by @brown_habitat_2000 emphasizes a heightened tolerance for habitats with salinity concentrations below 15 psu, deeming concentrations exceeding 20 psu unsuitable for spawning adults. 

Field studies further document that adult alewives exhibit spawning activities across diverse habitats with varying salinity concentrations, including coastal ponds, pond-like regions in coastal rivers and streams, oxbows, eddies, backwaters, stream pools, flooded swamps, and drowned river valleys [@pardue_habitat_1983; @mullen_species_1986; @collette_fishes_2002; @walsh_early_2005]. Notably, utilizing estuaries and brackish habitats for spawning may offer energetically favorable conditions for alewives, as it eliminates the need for them to acclimate to complete freshwater environments [@dimaggio_spawning_2015]. 
...
+----------------------------+---------------------+-------------------------------+------------------------+------------------------+
| **Parameter**              | Range               | **Habitat Suitability Value** | **Brown et al. (2000)**| **Pardue (1983)**      |
+============================+=====================+===============================+========================+========================+
...
Although SAV is thought to provide spawning and nursery habitat for most anadromous and resident fishes, alewife larval catch is inversely related to SAV density, with larvae most frequently found in areas with less than 10 percent vegetation density and never in areas exceeding 30 percent vegetation density [@ingel_habitat_2013]. Observations by @schmidt_communities_1988 further highlight the impact of vegetation cover, like water-chestnut and water celery beds, on the distribution of larvae, with a decline in larval abundance following the establishment of dense water-chestnut cover. These findings emphasize the importance of soft substrates and vegetation coverage in egg and larvae habitat for alewives.
...
However, it's essential to consider potential genetic separation and adaptation along the species range. The last stock assessment identified distinct stocks in the Gulf of Maine, Southern New England, and the Mid-Atlantic [@asmfc_river_2017]. Many of the data available are from the Mid-Atlantic and, therefore, may represent populations more thermally adapted to warmer waters. The thermal tolerance of a Maine alewife may differ from that of a Virginia alewife, indicating potential variations in temperature preferences and tolerances among different populations. 
